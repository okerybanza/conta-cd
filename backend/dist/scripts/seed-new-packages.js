...
async function main() {
    ...
    const pro = await prisma.packages.upsert({
        ...
        update: {
            ...
            price: new client_1.Prisma.Decimal('20000'),
            currency: 'CDF',
            billing_cycle: 'monthly',
            limits: {
    ...
    const premium = await prisma.packages.upsert({
        ...
        update: {
            ...
            price: new client_1.Prisma.Decimal('50000'),
            currency: 'CDF',
            billing_cycle: 'monthly',
            limits: {
                customers: null,
    ...
    for (const subscription of existingSubscriptions) {
        ...
        const newPackageId = newPlans[newCode];
        if (newPackageId) {
...
//# sourceMappingURL=seed-new-packages.js.map