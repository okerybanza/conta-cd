...
async function testTrigger() {
    ...
    try {
        ...
        const period = await database_1.default.fiscal_periods.upsert({
        ...
        await database_1.default.journal_entries.create({
            data: {
...
testTrigger();
//# sourceMappingURL=verifyFiscalPeriodTrigger.js.map