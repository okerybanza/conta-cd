...
exports.AgedBalanceService = void 0;
...
class AgedBalanceService {
     ...
     */
    getDaysOverdue(dueDate, asOfDate) {
     ...
     */
    distributeAmountByAge(amount, daysOverdue) {
        if (daysOverdue <= 0) {
            return {
                current: amount,
                days1_30: 0,
     ...
     */
    async generateAgedReceivables(companyId, asOfDate) {
        ...
        const averageDaysOverdue = items.length > 0
            ? items.reduce((sum, item) => sum + item.daysOverdue, 0) / items.length
            : 0;
        logger_1.default.info(`Aged receivables generated for company ${companyId}`, {
            companyId,
            asOfDate: date,
     ...
     */
    async generateAgedPayables(companyId, asOfDate) {
        const date = asOfDate || new Date();
        ...
        for (const expense of expenses) {
            ...
            items.push({
                ...
                supplierName: expense.suppliers?.name || expense.supplier_name || 'Non spécifié',
        ...
        const averageDaysOverdue = items.length > 0
            ? items.reduce((sum, item) => sum + item.daysOverdue, 0) / items.length
            : 0;
        logger_1.default.info(`Aged payables generated for company ${companyId}`, {
            companyId,
            asOfDate: date,
            totalItems: items.length,
            totalAmount: totals.total,
...
exports.AgedBalanceService = AgedBalanceService;
exports.default = new AgedBalanceService();
//# sourceMappingURL=agedBalance.service.js.map