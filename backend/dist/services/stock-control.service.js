...
exports.StockControlService = void 0;
...
class StockControlService {
     ...
     */
    async detectProductsInvoicedWithoutMovement(companyId) {
        const alerts = [];
     ...
     * DOC-03 : Indicateur obligatoire
     */
    async detectMovementsWithoutReference(companyId) {
        const alerts = [];
        const movements = await database_1.default.stock_movements.findMany({
            where: {
                company_id: companyId,
                status: 'VALIDATED',
                OR: [
     ...
     * DOC-03 : Indicateur obligatoire
     */
    async detectStockMismatches(companyId) {
        const alerts = [];
        ...
        for (const product of products) {
            const calculatedStock = await stock_movement_service_1.default.calculateStock(companyId, product.id);
     ...
     */
    async getAllAlerts(companyId) {
        const [invoicedWithoutMovement, movementsWithoutReference, stockMismatches,] = await Promise.all([
        ...
        logger_1.default.info(`Stock control alerts generated`, {
            companyId,
...
exports.default = new StockControlService();
//# sourceMappingURL=stock-control.service.js.map