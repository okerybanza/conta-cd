...
import { ProductDetailSlideIn } from '../../components/products/ProductDetailSlideIn';
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                ...
                {!rows.length && (
                  <tr><td className="px-6 py-8 text-text-secondary" colSpan={4}>Aucun produit trouve.</td></tr>
                )}
              </tbody>
            </table>
          </div>
